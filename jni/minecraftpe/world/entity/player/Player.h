...
public:
	...
	Player(Level&, PacketSender&, GameType, NetworkIdentifier const&, std::unique_ptr<SkinInfoData, std::default_delete<SkinInfoData>>, mce::UUID, std::unique_ptr<Certificate, std::default_delete<Certificate>>);
	...
	float getXpNeededForNextLevel() const;
	bool isHungry() const;
	bool isViewer() const;
